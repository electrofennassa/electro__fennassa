...
// Les images peuvent être des URLs internet ou des chemins locaux
let produits = JSON.parse(localStorage.getItem('electro_produits')) || [
    {
        id: 1,
        nom: "Réfrigérateur Samsung RT38 450L",
        marque: "Samsung",
        categorie: "Refrigerateurs",
        prix: 5999,
        prixPromo: 4999,
        description: "Réfrigérateur combiné Samsung Digital Inverter 450L. Technologie économie d'énergie. Éclairage LED. Garantie 2 ans.",
        image: "https://images.unsplash.com/photo-1571175443880-49e1d25b2bc5?w=400"
    },
    {
        id: 2,
        nom: "Lave-linge LG F4J6 8kg",
        marque: "LG",
        categorie: "Lave-linge",
        prix: 4599,
        prixPromo: null,
        description: "Lave-linge frontal LG 8kg. Moteur Inverter Direct Drive. 14 programmes. Essorage 1400 tr/min.",
        image: "https://images.unsplash.com/photo-1626806787461-102c1bfaaea1?w=400"
    },
    {
        id: 3,
        nom: "Lave-vaisselle Bosch SMS46",
        marque: "Bosch",
        categorie: "Lave-vaisselle",
        prix: 3999,
        prixPromo: 3499,
        description: "Lave-vaisselle Bosch 13 couverts. Classe A++. Silence 46dB. 6 programmes.",
        image: "https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400"
    },
    {
        id: 4,
        nom: "Cuisinière Whirlpool AKP 745",
        marque: "Whirlpool",
        categorie: "Cuisinieres",
        prix: 2999,
        prixPromo: null,
        description: "Cuisinière 4 feux gaz Whirlpool. Four électrique 65L. Allumage intégré. Garantie 1 an.",
        image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400"
    },
    {
        id: 5,
        nom: "Four Encastrable Electrolux 60cm",
        marque: "Electrolux",
        categorie: "Fours",
        prix: 2499,
        prixPromo: 1999,
        description: "Four électrique encastrable Electrolux 60cm. Chaleur tournante. Nettoyage catalyse. Minuterie.",
        image: "https://images.unsplash.com/photo-1590794056226-79ef3a8147e1?w=400"
    },
    {
        id: 6,
        nom: "Micro-ondes Samsung 28L Grill",
        marque: "Samsung",
        categorie: "Micro-ondes",
        prix: 899,
        prixPromo: null,
        description: "Micro-ondes Samsung 28L avec Grill. 10 niveaux de puissance. Décongélation automatique.",
        image: "https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?w=400"
    },
    {
        id: 7,
        nom: "Climatiseur LG Split 12000BTU",
        marque: "LG",
        categorie: "Climatiseurs",
        prix: 4999,
        prixPromo: 4499,
        description: "Climatiseur split LG Inverter 12000BTU. Froid/Chaud. Télécommande. Filtre anti-bactéries.",
        image: "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=400"
    },
    {
        id: 8,
        nom: "Téléviseur Samsung 55\" 4K UHD",
        marque: "Samsung",
        categorie: "Televiseurs",
        prix: 6999,
        prixPromo: 5999,
        description: "TV LED Samsung 55 pouces 4K UHD. Smart TV. WiFi intégré. HDR. 3 HDMI.",
        image: "https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=400"
    },
    {
        id: 9,
        nom: "Aspirateur Bosch Serie 4",
        marque: "Bosch",
        categorie: "Aspirateurs",
        prix: 1499,
        prixPromo: null,
        description: "Aspirateur sans sac Bosch Serie 4. Puissance 2400W. Filtre HEPA. Rayon 10m.",
        image: "https://images.unsplash.com/photo-1558317374-067fb5f30001?w=400"
    },
    {
        id: 10,
        nom: "Chauffe-eau Ariston 100L",
        marque: "Ariston",
        categorie: "Chauffe-eau",
        prix: 1999,
        prixPromo: 1799,
        description: "Chauffe-eau électrique Ariston 100L. Installation verticale. Thermostat réglable. Garantie 3 ans.",
        image: "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=400"
    }
];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Prévisualisation image dans l'admin
    document.getElementById('adminFormImage')?.addEventListener('input', function() {
        previewAdminImage(this.value);
    });
});
...
function previewAdminImage(url) {
    ...
    if (url && url.trim()) {
        preview.innerHTML = `<img src="${url.trim()}" alt="Prévisualisation" onerror="this.style.display='none'; this.parentElement.innerHTML='<p style=color:#e74c3c;>❌ Image introuvable</p>';">`;
    } else {
        ...
        produitsFiltres.map(p => `
            <div class="produit-card" onclick="ouvrirProduit(${p.id})">
                ...
                <div class="produit-image">
                    ${p.image 
                        ? `<img src="${p.image}" alt="${p.nom}" loading="lazy" onerror="this.style.display='none'; this.parentElement.innerHTML='<span class=no-image>📦</span>'">` 
...
function ouvrirProduit(id) {
    ...
    document.getElementById('modalBody').innerHTML = `
        <div class="produit-image-modal">
            ${p.image 
                ? `<img src="${p.image}" alt="${p.nom}" onerror="this.style.display='none'; this.parentElement.innerHTML='<span style=font-size:80px;>📦</span>'">` 
        ...
        content.innerHTML = panier.map(item => {
            ...
            return `
                <div class="panier-item">
                    <span>
                        ${item.image ? `<img src="${item.image}" style="width:40px;height:40px;object-fit:contain;border-radius:5px;vertical-align:middle;margin-right:8px;">` : '📦'}
...
function chargerAdminProduits() {
    ...
    tbody.innerHTML = produits.map(p => `
        <tr>
            <td>
                ${p.image 
                    ? `<img src="${p.image}" alt="${p.nom}" onerror="this.style.display='none'; this.parentElement.textContent='📦';">` 
                    : '📦'}
            </td>
            <td>${p.id}</td>
            <td>${p.nom}</td>
